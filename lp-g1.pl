...
*				Poss_Final		Movimentos possiveis - RESULTADO PRETENDIDO
*
...
/******************************************************************************
* predicados auxiliares usados em movs_possiveis
*******************************************************************************/

% Devolve o N-esimo elemento de uma lista
n_esimo(1, [X|_], X).
n_esimo(N, [_|L], X) :- N1 is N - 1, n_esimo(N1, L, X).


% Remove os elementos iguais a X da lista
remove_elemento([], _, []) :- !.
remove_elemento([H|T1], H, L) :- 		remove_elemento(T1, H, L).
remove_elemento([H|T1], X, [H|L]) :-	remove_elemento(T1, X, L).


% Remove da primeira lista elementos que sejam iguais a qualquer elemento da segunda
...
*				(L2,C2)			Coordenada 2
*				Dist 			Distancia entre as duas coordenadas	- RESULTADO PRETENDIDO
*
...
*				Lista_Movs		Lista com os movimentos efetuados - RESULTADO PRETENDIDO
*
...
*				Lista_Movs		Lista com os movimentos efetuados - RESULTADO PRETENDIDO 	
*
* Description:  Resolve um labirinto usando o predicado ordena_poss
*******************************************************************************/
...
*				Possibilidades de movimento organizadas - RESULTADO PRETENDIDO
*				Posicao inicial
*				Posicao final  	
*
